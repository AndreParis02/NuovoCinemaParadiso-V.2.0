...
<section>
  ...
  <div class="grid grid-2">
    <article class="card">
      ...
      <div class="list">
        ...
        <div class="list-item">
          ...
          @if (modificabileDa()) {
          <div class="btn-row">
            <button class="btn btn-secondary" type="button" (click)="inizioModifica(item)">
              Modifica
            </button>
    ...
    <article class="card">
      ...
      @if (!modificabileDa()) {
      <div>Il tuo ruolo non ti permette di modificare o eliminare film.</div>
      }
      ...
      <form class="form-grid" [formGroup]="form" (ngSubmit)="invia()">
        ...
        <div class="btn-row">
          <button
            ...
            type="submit"
            [disabled]="staInviando() || !modificabileDa()"
          >
            {{ staInviando() ? 'Salvataggio...' : (modificaId() ? 'Aggiorna' : 'Crea') }}
          </button>
          @if (modificaId()) {
          <button class="btn btn-secondary" type="button" (click)="ripristinaForm()">
            Annulla
          </button>
          }
        </div>
