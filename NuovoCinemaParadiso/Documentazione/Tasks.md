...
- ANDREA PARIS:CONTROLLARE IL README (GIFTCARD, GENEREMOVIE, CONTOCINEMA)

- FABIO: CONTROLLARE LA RISCOSSIONE DELLA GIFTCARD SU POSTMAN

- ANDREA BRUNO: CONTROLLARE I DTO ORA CHE NON è PRESENTE LA GIFT CARD

- ANDREA BRUNO: CONTROLLARE I DTO CHE COMPRENDONO IL SALDO DELL'UTENTE SIA NEI FILE CHE NEL README.

- FRANCESCO: CONTROLLARE LE OPERAZIONI DI ACQUISTO BIGLIETTO, TRASFERIMENTO DENARO SU CONTO CINEMA.

- SIMEONE: CONTROLLARE CHE SIA SOLO IL GESTORE A LEGGERE GLI AUDIT(LOG).

- LORENZO: CONTROLLARE CHE SIA SOLO IL GESTORE A LEGGERE LA LISTA DEI BIGLIETTI.

- MARCO: MODIFICA DTO IN INGRESSO PER ABBONATI IN UTENTE CONTROLLER.
